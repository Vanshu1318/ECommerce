        ...
        function createObject(id,a,b,c,s,p){
            const obj={
                id:id,
                product:a,
                price:b,
        ...
        btn.addEventListener("click",()=>{
            ...
            const obj=createObject(i,product.value,price.value,desc.value,status,pic.value);
        ...
        function display(obj,i){
          ...
          // div.style.marginDown='10px';
           ...
           del.classList.add("dives", "delete");

           updt.classList.add("dives", "update");
          ...
          //del.style.alignItems="right";
           ...
           chk.addEventListener("change", () => {
            if (chk.checked) {
                // Reduce opacity when the checkbox is checked
                prodiv.style.opacity = 0.3;
                pricediv.style.opacity = 0.3;
                descdiv.style.opacity = 0.3;
                obj.status = "completed";
                updateProductInLocalStorage(obj.id, obj);
            } else {
                // Restore opacity when the checkbox is unchecked
